...
Sometimes you don't know when, or even if, an the data stored in an object will
be used again. If the data is cheap to recompute, or refetch from some external
data source, then a good policy would be to make sure it lives only as long as
it is clearly needed. Performing a few dozen machine instructions is very
...
used in the future, then it might be worthwhile keeping it around. 
