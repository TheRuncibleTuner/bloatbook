...
It is important to understand this distinction, between natural and actual
lifetime, so that you can implement your code in a way that avoids bugs and performs well in
...
The lifetime of 
An object's lifetime spans its creation, use,

\autoref{fig:typical-lifecycle}
...
\begin{lstlisting}[float,caption=Code that constructs 8 temporary
