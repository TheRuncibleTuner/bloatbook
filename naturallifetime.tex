...
The fifth main facet of object lifetime are those objects that stay around for
an indeterminant period of time. In some cass, this period based on the
profitability of keeping them around. In other cases, it is based upon whether
the 
