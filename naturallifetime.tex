...
A web application server uses preloaded catalog data, maintains data for users
as they interact with the system, and optionally caches data that is fetched
from a remote database. How does Java heap consumption vary over time, and how
should each of these uses of memory be apportioned?
\end{example}
