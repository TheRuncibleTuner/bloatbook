...
\usepackage{footnote} % GSS: to allow footnotes in a table
...
\def\TLS{Thread-local Storage\xspace}
\def\tlsindex{\index{Thread-local Storage}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%                                       %%%%%%
%%%%%% MACRO for Java 5 (1.5, 5.0?)          %%%%%%
%%%%%% MACRO for Java 6 (1.6?)               %%%%%%
%%%%%%                                       %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\javafive{Java 5\xspace}
\def\javasix{Java 6\xspace}
\def\javaseven{Java 7\xspace}
...
\def\jress{JRE's\xspace}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%                                       %%%%%%
%%%%%% MACRO for version of JRE              %%%%%%
%%%%%%       maybe HotSpot/J9 instead?       %%%%%%
%%%%%%                                       %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%% [GSS] including placeins package to get \FloatBarrier command
\usepackage{placeins}
...
\lstset{language=Java,basicstyle=\ttfamily,frame=tb,tabsize=4,captionpos=b,columns=flexible,breaklines,showstringspaces=false}%},frame=single,backgroundcolor=\color{Light}}
\lstnewenvironment{shortlisting}{\quote\lstset{frame=none}}{\lstset{frame=tb}\endquote%
\vspace{-0.5\baselineskip}
}
\lstnewenvironment{nospanshortlisting}{\minipage{\linewidth}\quote\lstset{frame=none}}{\lstset{frame=tb,float}\endquote\endminipage%
\vspace{-0.5\baselineskip}
}
\lstnewenvironment{figurelisting}{\lstset{frame=tblr,backgroundcolor=\color{Light}}}{\lstset{frame=tb,backgroundcolor=\color{white}}%
}
\lstnewenvironment{framedlisting}{\lstset{frame=tblr,backgroundcolor=\color{Light}}}{\lstset{frame=tb,backgroundcolor=\color{white}}%
\vspace{-0.5\baselineskip}
}
...
% a macro to make a pretty C++
\newcommand{\CC}{C\nolinebreak\hspace{-.05em}\raisebox{.4ex}{\tiny\bf +}\nolinebreak\hspace{-.10em}\raisebox{.4ex}{\tiny\bf +}}

% a line drawn across the page to mark a separator
...
\def\thetitle{Building Memory-Efficient Java Programs}
\title{\thetitle}
...
% GSS Added the following line to fix header in TOC
...
\input{frontmatter/introduction} % the introduction chapter
\input{part1/part1}
\input{part2/part2}
\input{part3/part3}
