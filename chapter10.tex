...
\begin{figure}
	...
	\subfigure[The lifecycle of a typical object and its data.]{
		\includegraphics[width=\textwidth]{Figures/object-lifecycle}
	}
	\subfigure[The lifecycle of the data  that is loaded from
	disk three times, and the objects that store it.]{
		\includegraphics[width=\textwidth]{Figures/object-lifecycle2}
	}
...
invocation: when the servlet \code{doGet} or \code{doPut} (etc.) invocations
