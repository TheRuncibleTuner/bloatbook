...
\autoref{sec:time-space-tradeoffs} gives strategies for implementing caches in
Java. If the data to be cached is stored on a local disk, then another strategy
to caching is to use \emph{memory mapping}. \autoref{sec:memory-mapping}
