...
\centering
	\begin{tabular}{rl}
	\toprule
	tradeoff mechanism & purpose \\ \cmidrule(r){1-1} \cmidrule(l){2-2}
	cache & amortizing time cost of a computation or data access
	\\
	sharing pool & amortizing space cost of duplicate data
	\\
	resource pool & avoiding excessive resource consumption
	\\ \bottomrule
	\end{tabular}
\end{table}
