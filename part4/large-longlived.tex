...
then your application will have a memory bloat factor of at least 44\%
% 16/(10*2 + 16)
...
wrapped inside of \class{String} objects, then your applicaiton is doomed to a
memory bloat factor of at least 70\%.
% (16+32)/(10*2+16+32)
...
solution. In any case, however, interning only \emph{indirectly} tackles the
problem at hand. By keeping only a single canonical copy of the primitive data,
you eliminate the primitive array headers for the duplicates.

By eliminating many duplicates via interning, you stand to save lots of memory,
but your memory bloat factor will still be quite high. Instead of a bloat factor
of 70\%, with interning your heap will have a bloat factor of 62\%.
...
objects are not eliminated by interning. Interning removes only the duplicate
primitive array overheads.

You could eliminate the \class{String} objects by 

In order to eliminate all of the primitive array overheads, and The bulk storage
that backs a set of data items, each of the same type. Objects share the data by indexing into the pool.
...
\centering
	...
	\qquad
	\subfigure[Bulk	sharing	pool.]{\includegraphics[width=0.425\textwidth]{part4/Figures/bulksharingpool3}}
	\qquad
	\subfigure[Bulk	sharing	pool.]{\includegraphics[width=0.425\textwidth]{part4/Figures/bulksharingpool4}}
...
%\begin{tabular}{c|ccc}
%\toprule
%Fraction Distinct & normal & interning & bulk sharing
%\\ \midrule
%1\% & 55.3MB & 34.5MB & 11.6MB
%\\
%10\% & 55.3MB & 36.4MB & 13.5MB
%\\
%20\% & 55.3MB & 38.5MB & 15.6MB
%\\
%30\% & 55.3MB & 40.6MB & 17.7MB
%\\
%40\% & 55.3MB & 42.7MB & 19.8MB
%\\
%50\% & 55.3MB & 44.8MB & 21.9MB
%\\
%60\% & 55.3MB & 46.9MB & 24.0MB
%\\
%70\% & 55.3MB & 49.0MB & 26.1MB
%\\
%80\% & 55.3MB & 51.1MB & 28.2MB
%\\
%90\% & 55.3MB & 53.2MB & 30.3MB
%\\
%100\% & 55.3MB & 55.3MB & 32.4MB
%\\ \bottomrule
%\end{tabular}
% normal = interning at 100%
%interning: 1000000*( 0.5*(10 + 12) + 32 + 4)/1024/1024
%BSP: 1000000*( .8*(10 + 12) + 8 + 4)/1024/1024
