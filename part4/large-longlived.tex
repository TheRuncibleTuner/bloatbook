...
These examples, which work through various optimizations of representing
relationships, illustrate the interplay of storage optimization and API design.
Very often, achieving a high level of memory efficiency requires breaking what
would generally considered to be the object orientation of an API.
