...
difficult ends. First, the difficulty of supporting nodes with widely varying
numbers of parents and children. If all nodes had only a very small number of incident
...
requires either expensive maps to parallel data structures, or extensive
