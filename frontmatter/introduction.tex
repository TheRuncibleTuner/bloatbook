...
A similar situation occurs with memory consumption.
Here, the story is not nearly as rosy. Modeling your data in Java is the process
of designing how to map bytes of data to fields and classes.
...
than inline.
The java runtime makes no attempt to inline that side array for you.
This lies in contrast to what the JIT does for methods: the JIT creates a small
number of larger methods by inlining small methods into larger ones.

This probably seems like height of madness, worrying about 16 bytes, in the age
of multi-gigabyte handheld devices. 


Java automatically reclaims memory that you
allocate, the frameworks you use offer caching and pooling mechanisms
