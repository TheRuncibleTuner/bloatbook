...
Let's say that you want to store one million pieces of information. 

Primitive data types are expensive, and storing data in the standard collections
comes with a high overhead. The story gets worse as you combine them into larger
data structures. With each added layer, expenses }
