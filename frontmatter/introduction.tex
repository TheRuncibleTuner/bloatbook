...
[NOTE: In the next few paragraphs there's a lot of overlap with the Preface.
...
[NOTE: Combine and streamline these two versions of the Facts and Fictions
intro]
...
[NOTE: Myths and Quiz go here.  This
is important info, not covered elsewhere in the book.
...
[NOTE: Quiz can be a callout or scattered callouts.
...
[NOTE: this is about our approach, and can give a roadmap of the book
too. Needs to be rewritten/restructured to reflect our current breakdown: space,
...
[NOTE: give only the highest-level description of E-C diagrams here.  E-C
diagrams are explained fully in Chapter 2.]
...
[NOTE: add data structure to the list]
