...
problem of overhead multiplies when you combine them.

\callout{quiz3}{The Big Pileup}{
%The ratio of overhead to actual data of each piece of information  
...
\begin{itemize}
  \item In a language like \C++, short strings, say 10 characters a piece,
...
\callout{quiz4}{Memory Leaks in a Managed Runtime}{
Java is often referred to as having a \emph{managed runtime}. An important part
of this is automatic garbage collection. The sales pitch here claims that manual
reclamation of memory isn't required, and, for the most part, this is actually
true.  }
