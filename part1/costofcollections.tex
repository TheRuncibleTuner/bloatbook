...
these are the number from both sun and IBM. What strikes me is that the smallest number 
...
so they’re still allocating the array with 0 size. Where as the Sun and older JVM’s are always 
