...
varies depending upon the elements a collection contains. 
 %instances of a collection class are not uniform in size.
%Instead, the memory overhead of each collection instance depends on the
...
growth.  Tables~\ref{tab:small-collections-default} through \ref{tab:empty-collection-costs} in
