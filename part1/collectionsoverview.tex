...
are high overall. The very smallest of the commonly-used collections, an
...
designed mostly for speed rather than space. They also seem to have been
...
small or empty collections, and in particular, when there are many instances of them.
...
at the time the collection is allocated, as well as later on as it grows. This
overhead is included in the fixed and variable costs.  
...
collection classes. \autoref{chapter:tables-indexes} shows
...
Finally, we do not recommend implementing your own collection classes, or at
least not until you have exhausted all other possibilities. First consider all
of the techniques in the next few chapters, as well as some of the more
space-efficient open source collection frameworks.
...
provide classes that make it easier to manage object lifetimes. Building your
own object lifetime management mechanisms can be error prone. Well-tested
implementations will save you a lot of effort, and can lead to better overall use of space.
...
\paragraph{Guava} The Guava framework, which grew out of the Google Collections,
...
\paragraph{Apache Commons Collections} The Apache Commons Collections framework
...
\paragraph{GNU Trove} The GNU Trove framework has time and space efficiency as
its main goal.
...
\paragraph{fastutil} The fastutil framework has similar goals to Trove,
