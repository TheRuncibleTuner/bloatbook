...
fine as an index over a large table, but can be prohibitively expensive when you
...
of elements. As a rule, \class{ArrayList} and other array-based collections have
