...
bloat factor for an array of 100 \code{char}s is insignificant. This is not the
...
enabled with the option -XX:+UseCompressedOops.\footnote{On \javaseven, 64-bit
Sun \jres have this enabled by default, as long as your heap size is smaller
than 32 gigabytes.} It is available in IBM \javasix (Service Release 4) with the
