...
separate objects. Table~\ref{tab:common-delegated-field-types} shows the space needs of a few common ones.
...
\end{tabular}
 % \includegraphics{eight-char-string}
  \caption{Memory requirements for the most common field types that are
  implemented as separate objects. Sizes do not include a referring
  pointer.
  }
