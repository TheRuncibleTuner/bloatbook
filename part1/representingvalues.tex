...
a result \class{String}. A \class{StringBuffer}\footnote{This discussion
applies equally to \class{StringBuffer} and \class{StringBuilder}. For
simplicity we'll say \class{StringBuffer} to mean either one.}, on the other hand, is mutable.
