...
inflated form. \class{BigDecimal} attempts uses the compact
...
some cases when formatting using \class{DecimalFormat}. This is an example of a
built-in performance optimization in the library, one that may not be needed
