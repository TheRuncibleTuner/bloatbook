...
\begin{figure}
 ...
 % \includegraphics{eight-char-string}
  ...
  bytes of memory to a side object. The x-axis is the fill rate as a percent.
  The y-axis is the average memory saved per instance, as a percent of the bytes
  delegated.}
  \label{fig:fill-rate}
\end{figure}
...
\begin{itemize}
  \item Expose interfaces rather than concrete classes.
  \item Expose factory methods rather than constructors.
\end{itemize}
