...
Using a side object will result in positive
...
alignment (e.g.the IBM 32-bit JRE), a side object can
...
class with lazy allocation, but then have code paths that
...
Lazy allocation
can be error-prone also because it may require testing whether the object
exists at every use. Extra care is required if you
need concurrent access to the data. This complexity has to be weighed against potential memory
savings.
