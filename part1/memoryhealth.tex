...
While this is a big improvement, 44\% overhead still seems high. Over half the
...
factor as a data structure grows. The \code{TreeMap} design has 74\% overhead
...
a per-entry cost of 56\%, that remains constant.
