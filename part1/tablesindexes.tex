...
headers, becomes insignificant.  For example, for an \class{ArrayList} with just
1000 elements, the fixed cost is just .1\% of the total.  
%Whereas with small collections we need to concern
...
when it needs extra space, and \class{HashMap} doubles the number of buckets when the number of elements reaches
