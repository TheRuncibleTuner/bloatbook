...
Some alternative frameworks provide a different approach to reducing space in
...
On example is in the Apache Commons framework, which lets you subclass its map
...
your code doesn't break anything in current and future versions of their hash
map implementation.
