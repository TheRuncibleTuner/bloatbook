...
whenever you want to create an new \code{Integer}. Unlike the string pool, the \class{Integer}
pool is initialized to store all \class{Integers} in a fixed range, from -128 to 127 by
...
constructor, to create a new \class{Integer}. The pooling aspect is very
