...
\begin{figure}
\centering
	\subfigure[]{\label{fig:sharing-pool-a}\includegraphics[width=0.445\textwidth]{part1/Figures/modelingdatatypes/sharing-pool-a.pdf}}
...
\class{String}, so interning \class{String}s indiscriminately will waste memory.
In this example there is likely to be a lot of duplication
among the property values. Rather than interning the value \class{String}s for
