...
\centering
 		...
 		\toprule
	 	 ...
	 	 & fixed & variable & comments \\
	 	 \midrule
	 	ArrayList & 36  & 4 & for any n \footnotemark[1] \\
	 	\midrule
...
\centering
	 	...
	 	UnmodifiableMap & - & - & 24 & - & add'l cost \footnotemark[8]\\
	 	\midrule
	 	SynchronizedList & - & - & 24  & - & add'l cost \\	 	
	 	SynchronizedSet & - & - & 16  & - & add'l cost \\	 	
	 	SynchronizedMap & - & - & 32  & - & add'l cost \footnotemark[9]\\	 	
	 	\midrule
	 	\multicolumn{5}{l}{Guava:} \\
	 	\midrule
	 	ImmutableList & 40 & 56 & 36  & 4 & for any n \footnotemark[6]\\
	 	ImmutableSet & 64 & 96 & 64  & 8 & for any n \footnotemark[7]\\
	 	ImmutableSortedSet & 40 & 56 & 36 & 4 & for any n \footnotemark[6] \\
	 	 \midrule
	 	\multicolumn{5}{l}{fastutil:} \\
	 	\midrule
	 	ObjectArraySet & 32 & 48 & 28 & 4 & for any n \footnotemark[6] \\
	 	\midrule
	 	\multicolumn{5}{l}{Java 1 collections:} \\
	 	\midrule
	 	Vector & 40 & 56 & 36 & 4 & for any n \footnotemark[6] \\ 	
	 	\bottomrule
	 	\end{tabular}
...
\footnotetext[6]{Round total cost up to nearest 8 bytes.}
\footnotetext[7]{Round total cost up to nearest 16 bytes.}
\footnotetext[8]{There is an additional fixed cost if you iterate over the keys
...
collection.} 
\footnotetext[9]{There is an additional fixed cost if you iterate over the keys,
