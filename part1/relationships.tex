...
guarantee that there are no inadvertent
...
section. In some applications, the contents of a relationship may even be known
at load time, and will remain constant thereafter. In these cases you can allocate an
immutable collection right from the start.
