...
list of \class{HashMap\$Entry} objects. Each entry object points to an element of the user's data, in other
words, to a key and value.
% to allow for growth and reduce collisions.
...
Fixed costs for an \class{ArrayList} include the single wrapper object and the
...
cost is not reflected in any of the figures or discussion.}.
 ...
 The variable cost of a \class{HashSet} is 24 bytes. Lower variable
cost means that \class{ArrayList} scales much better than \class{HashSet}. So \class{ArrayList} is better both for small and large sets.
 \begin{figure}
  \centering
...
\centering
 		...
 		\toprule
	 	 ...
	 	 & & & Fixed & Variable & Range \\
	 	 \midrule
	 	ArrayList & 48 & 56 & 40 & (n/2)*8 & 0 .. 10 \\
 		HashMap & 112 & 184 & 88 & 24 & 0 .. 5 \\
 		HashSet & 128 & 200 & 104 & 24 & 0 .. 5 \\
	 	\bottomrule
 	 	\end{tabular}
