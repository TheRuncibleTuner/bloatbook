...
very small \class{HashSets}s, each consuming 232 bytes, for a total cost of 22.125MB. 
...
is expensive memory-wise. \class{HashSet} is implemented as a degenerate
\class{HashMap}, that is, a \class{HashMap} with no values. 
...
variable cost than \class{HashSet}. It is really just an expandable array,
