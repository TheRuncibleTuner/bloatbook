...
However, an application's relationships may have
...
The extra space can be eliminated with no loss of performance. The same holds
true for larger collections the stop growing. 
