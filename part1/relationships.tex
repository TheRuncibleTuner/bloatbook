...
The initial capacity is actually not the number of elements the collection is
...
capacity it's important to take the load factor into account.
...
suppliers on average, but a few products have over 100 alternate suppliers each. We
