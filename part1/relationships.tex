...
before a larger array needs to be allocated. For example, a default
\class{HashMap} with capacity of 16 can hold a maximum of 12 elements
before needing to reallocate the array (to capacity 32). When
setting the initial capacity it's therefore important to take the load factor
into account.
