...
For a \class{HashSet} the fixed cost consists of two wrapper objects at 56 bytes, plus
...
\footnote{\class{HashSet} actually has an additional fixed cost in a
common usage scenario. The first time you iterate over the contents of
the set, an additional 16-byte \class{HashMap\$KeySet} object is created, and retained for the lifetime of
the set. This cost doesn't appear in our figures.}.
...
\centering
 		...
 		\toprule
	 	 Collection & \makebox{with 1 entry} & \makebox{with 4 entries} & \multicolumn{2}{c}{with n entries}\\
	 	 & & & fixed + n*variable & comments \\
	 	 \midrule
	 	ArrayList & 80 & 80 & 80 & for n in 0..10 \\
 		HashMap & 144 & 216 & 120 + n*24 & for n in 0..11 \\
 		HashSet & 160 & 232 & 136 + n*24 & for n in 0..11 \\
 		LinkedList & 72 & 144 & 48 + n*24 & for any n \\
	 	\bottomrule
	 	\end{tabular}
...
\centering
 		...
 		\toprule
	 	 ...
	 	 & & & fixed + n*variable & comments \\
	 	 \midrule
	 	ArrayList & 48 & 56 & 40 + (n/2)*8 & for any n, capacity = n \\
 		HashMap & 88 & 184   & 64 + n*24 & for n in 0..1, capacity = 2 \\
 		        &     &  & 88 + n*24 & for n in 3..5, capacity = 8 \\
 		HashSet & 104 & 200 & 80 + n*24 & for n in 0..1, capacity = 2 \\
		        &     & & 104 + n*24 & for n in 3..5, capacity = 8 \\
	 	\bottomrule
 	 	\end{tabular}
	\caption{Costs of some common collection classes when capacity is set
	to the minimum to accomodate the number of entries shown.}
