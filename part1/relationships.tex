...
%	\caption{}\label{tab:small-collections-minimum}{}
	...
	elements. Variable cost is the additional cost per entry, above the fixed
	cost. Numbers apply only within the specified range.
	(a) Default size (b) Minimum size.[TODO: format as a table with two subtables]}
