...
leads to memory bloat. A quick look inside any empty collection shows that it is not all that empty. 
Even if the default initial capacity is overridden and set to zero, empty
collections are still large. A zero-sized \class{ArrayList}
...
find that many collections remain empty throughout an execution.
