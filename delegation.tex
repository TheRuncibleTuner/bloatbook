...
\end{enumerate}
The object header size, the object alignment, and the sizes of the fields
depend on the \jre. For example, the \jre may pack fields to obtain the minimum
possible size (e.g. Sun), or align fields on word boundaries (e.g. IBM). Array data is always packed. }
