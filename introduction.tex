...
Managing your Java program's use of memory couldn't be easier, or so it would
seem. Java provides you with automatic garbage collection, a compiler that
runs as your program is running, even responding to your program's operation, and
a growing list of standard, open source, and proprietary libraries, such as collections,
written by experts. All you have to do is piece together the parts and let the runtime do the rest for you.
...
\emph{much} higher than imagined.  What's more, < something about lifetime
here > .
...
\comment{move a lot of this to preface as motivation/inspiration for book}
...
In addition to the technical reality of layers and layers of abstraction, there
...
\emph{Myth.} Memory is cheap, hardware is always improving, so things are fine.
...
\emph{Myth.} The JIT optimizer and garbage collector are so good that they will
