...
\bold{Misconception.} Memory is cheap, hardware is always improving, so things are fine.
\bold{Reality.} With gigabytes of memory available, you never need to worry about running out.
...
\bold{Misconception.} The JIT optimizer and garbage collector are so good that they will
