...
reclaimed. If you implement a \code{finalize} method in a class, then every
...
finalizer queue, invoking the \code{finalize} method of the enqueued objects.
...
program creates instances of objects with \code{finalize} methods at a high
rate.
...
System.runFinalization()}. In this case, this change fixes the problem.
% \end{comment}
