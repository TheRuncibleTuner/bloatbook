...
\begin{table}
  \centering
%\includegraphics[width=.50\textwidth]{part2/Figures/chapter4/primitive-byte-sizes.pdf}
...
\begin{table}
  \centering
%\includegraphics[width=.70\textwidth]{part2/Figures/chapter4/boxed-scalar-sizes.pdf}
...
a specific employee ``John Doe" is shown in Figure~\ref{fig:employee-status}.
 \begin{figure}
  \centering
 \includegraphics[width=.80\textwidth]{part2/Figures/chapter4/employee-status.pdf}
 % \includegraphics{eight-char-string}
...
\end{shortlisting}
 \begin{figure}
  \centering
 \includegraphics[width=\textwidth]{part2/Figures/chapter4/employee-status-fine-grained.pdf}
 % \includegraphics{eight-char-string}
...
Figure~\ref{fig:refactored-fine-grain} shows the memory layout after these changes. Both the size and the bloat factor have been reduced.
 \begin{figure}
  \centering
 \includegraphics[width=\textwidth]{part2/Figures/chapter4/refactored-fine-grain.pdf}
 % \includegraphics{eight-char-string}
...
\begin{figure}
  \centering
 \includegraphics[width=.70\textwidth]{part2/Figures/chapter4/big-base-class.pdf}
 % \includegraphics{eight-char-string}
...
%\end{example}
 ...
 \includegraphics[width=0.8\textwidth]{part2/Figures/chapter4/8-char-string-64-bit.pdf}
 % \includegraphics{eight-char-string}
