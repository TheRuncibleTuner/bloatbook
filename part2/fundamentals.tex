...
\centering
	...
	purposes.]{\label{fig:heaps_and_stacks_java}\includegraphics[width=0.75\textwidth]{part2/Figures/lifetime/heaps_and_stacks_java}}
	%\qquad
	\subfigure[When
	using
	...
	]{\label{fig:heaps_and_stacks_C}\includegraphics[width=0.75\textwidth]{part2/Figures/lifetime/heaps_and_stacks_C}}
	...
	via
	{\tt
	-XX:MaxPermSize}.]{\label{fig:heaps_and_stacks_C}\includegraphics[width=0.75\textwidth]{part2/Figures/lifetime/heaps_and_stacks_classes}}
