...
An entity-collection diagram for a 100-entry map of doubles using TreeMap is shown in Figure~\ref{fig:content-schematic-treemap-doubles}.  The total cost of this data structure is 8.5KB. Since there is only 1.6KB of data, the overhead is 7KB, which is 82\%. What is costing so much?
