...
\shortstack{
	\includegraphics[width=0.3\textwidth]{part3/Figures/extreme/exampleGraph}
	\\ \vspace{5mm}
	}
}
\qquad
...
\label{fig:example-storing-relations-graph-with-node-numbers}
	\includegraphics[width=0.3\textwidth]{part3/Figures/extreme/exampleGraph-withNodeNumbers}
}
\quad
