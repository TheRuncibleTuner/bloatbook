...
of one class into another. You of course make a best effort, but too much of
this runs at odds to principled engineering. Often, you are blocked because you
run into code that you do not own, or base classes whose field layout is locked
...
\begin{figure}
\centering
   \subfigure[Entities are objects, attributes are fields.]{
      \includegraphics[width=0.45\textwidth]{part3/Figures/extreme/EC-example-for-columns1}
      }
      \quad
   \subfigure[Entity attributes are stored in arrays of
   data.]{
      \includegraphics[width=0.3\textwidth]{part3/Figures/extreme/EC-example-for-columns2}
      }
\end{figure}
