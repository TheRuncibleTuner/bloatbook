...
the \emph{scalability} of a data structure. You should only focus on tuning
those structures that scale poorly. The scalability of a data structure depends
upon how its bloat factor changes as its size increases. Up till now, bloat
factor has been a scalar quantity: e.g., 95\% of space is implementation
overhead. More accurately, the bloat factor of a data structure is a function of
its size. Its bloat factor will decrease, as fixed costs are amortized over a
larger amount of actual data.
