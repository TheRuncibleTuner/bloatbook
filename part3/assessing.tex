...
$$\frac{\textrm{fixed cost}}{\textrm{total costs}} = \frac{48}{48 + 128 N}
\le 0.05 \Longrightarrow N \ge 5.45$$
...
the ultimate scalability of most data structure:
...
\includegraphics[width=0.4\textwidth]{part3/Figures/assessing/EC-example}
...
with the four numbers that govern the scalability of this structure: the fixed
and variable costs of the collection you use, and the unit cost and bloat
factor of the data you're storing inside of it.}
