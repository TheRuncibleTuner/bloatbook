...
small example is illustrated in \autoref{fig:example-storing-relations-graph}.
For example, when caching data from a relational database in the Java heap, each
